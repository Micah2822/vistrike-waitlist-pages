      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          <p className="hero-body animate-fade-in animate-delay-2" data-testid="text-body">
            Vistrike helps fighters train smarter with real-time feedback on every punch, every round, every session — straight to your device, no extra equipment needed.
          </p>
